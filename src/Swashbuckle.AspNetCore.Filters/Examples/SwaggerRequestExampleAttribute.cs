...
namespace Swashbuckle.AspNetCore.Filters
{
    ...
    public class SwaggerRequestExampleAttribute : Attribute
    {
        ...
        public SwaggerRequestExampleAttribute(Type requestType, Type examplesProviderType, Type contractResolver = null, Type jsonConverter = null, bool renderNulls = false)
        {
